...
CategoryEntity _categoryEntityDeserialize(
  ...
  object.categoryType = reader.readStringOrNull(offsets[1]);
  object.colorHex = reader.readLongOrNull(offsets[2]);
...
extension CategoryEntityQuerySortBy
  ...
  QueryBuilder<CategoryEntity, CategoryEntity, QAfterSortBy> sortByColorHex() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CategoryEntity, CategoryEntity, QAfterSortBy> sortByCurrency() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryEntityQuerySortThenBy
  ...
  QueryBuilder<CategoryEntity, CategoryEntity, QAfterSortBy> thenByColorHex() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'colorHex', Sort.asc);
    });
  }
  ...
  QueryBuilder<CategoryEntity, CategoryEntity, QAfterSortBy> thenByCurrency() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'currency', Sort.asc);
    });
  }
...
extension CategoryEntityQueryWhereDistinct
  ...
  QueryBuilder<CategoryEntity, CategoryEntity, QDistinct> distinctByColorHex() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'colorHex');
    });
  }

  QueryBuilder<CategoryEntity, CategoryEntity, QDistinct> distinctByCurrency(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryEntityQueryProperty
  ...
  QueryBuilder<CategoryEntity, int?, QQueryOperations> colorHexProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'colorHex');
    });
  }

  QueryBuilder<CategoryEntity, String?, QQueryOperations> currencyProperty() {
    return QueryBuilder.apply(this, (query) {
